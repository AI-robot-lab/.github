...
Witaj w **AI Robot Lab**! Cieszymy się, że chcesz dołożyć swoją cegiełkę do rozwoju naszych robotów humanoidalnych. Aby współpraca przebiegała sprawnie, a nasz kod (i roboty) pozostały w jednym kawałku, prosimy o przestrzeganie poniższych zasad.

---

## Model Pracy z Gitem (Git Flow)
